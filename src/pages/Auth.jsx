...
function Auth({ isOpen, onClose, showHero = true }) {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      setEmailVerificationStatus(otpType === "email" ? "verified" : "idle");
      ...
      if (response.data.message === "Login Success") {
        ...
        localStorage.setItem(
          ...
          JSON.stringify({
            ...
            email: response.data.email || (isEmailLogin ? loginData.login : ""),
            phone: !isEmailLogin ? loginData.login : "",
            company: "",
            city: "",
