!(function (e) {
  ...
  function i(i, p) {
            ...
            (e.append(
              $("<td>").append(
                $("<a>")
                  ...
                  .append($("<span>").addClass(p.icons.up))
              )
            ),
            t.append(
              $("<td>").append(
            ...
            a.append(
              $("<td>").append(
                $("<a>")
                  ...
                  .append($("<span>").addClass(p.icons.down))
              )
            )),
          d("m") &&
            (d("h") &&
              ...
              $("<tr>")
                .append(
                  $("<th>")
                    ...
                    .append($("<span>").addClass(p.icons.previous))
                )
                .append(
                  $("<th>")
                ...
                .append(
                  $("<th>")
                    ...
                    .append($("<span>").addClass(p.icons.next))
                )
            )),
            (a = $("<tbody>").append(
              $("<tr>").append(
              ...
              e.push(
                $("<td>").append(
                  $("<a>")
                    ...
                    .append($("<span>").addClass(p.icons.today))
                )
              ),
            !p.sideBySide &&
              u() &&
              ...
              e.push(
                $("<td>").append(
                  $("<a>")
                    ...
                    .append($("<span>").addClass(p.icons.time))
                )
              ),
            p.showClear &&
              e.push(
                $("<td>").append(
                  $("<a>")
                    ...
                    .append($("<span>").addClass(p.icons.clear))
                )
              ),
            p.showClose &&
              e.push(
                $("<td>").append(
                  $("<a>")
                    ...
                    .append($("<span>").addClass(p.icons.close))
                )
              ),
            $("<table>")
              .addClass("table-condensed")
        ...
        p.sideBySide && u() && l()
          ...
          : ("top" === p.toolbarPlacement && o.append(s),
            u() &&
              o.append(
                $("<li>")
                  .addClass(p.collapse && l() ? "collapse in" : "")
                  .append(r)
              ),
    ...
    function r(e) {
      "y" === e && (e = "YYYY"),
        h({ type: "dp.update", change: e, viewDate: H.clone() });
    }
    function o(e) {
      N &&
    ...
    function s() {
      var e,
        t,
        a,
        n = N.find(".datepicker-days"),
        r = n.find("th"),
        i = [],
        o = [];
      if (u()) {
        for (
          r.eq(0).find("span").attr("title", p.tooltips.prevMonth),
            r.eq(1).attr("title", p.tooltips.selectMonth),
            r.eq(2).find("span").attr("title", p.tooltips.nextMonth),
            n.find(".disabled").removeClass("disabled"),
            r.eq(1).text(H.format(p.dayViewHeaderFormat)),
            m(H.clone().subtract(1, "M"), "M") || r.eq(0).addClass("disabled"),
            m(H.clone().add(1, "M"), "M") || r.eq(2).addClass("disabled"),
          ...
          0 === e.weekday() &&
            ...
            i.push(t)),
            (o = ["day"]),
            e.isBefore(H, "M") && o.push("old"),
            e.isAfter(H, "M") && o.push("new"),
            e.isSame(E, "d") && !W && o.push("active"),
            m(e, "d") || o.push("disabled"),
            e.isSame(c(), "d") && o.push("today"),
            (0 !== e.day() && 6 !== e.day()) || o.push("weekend"),
            h({ type: "dp.classify", date: e, classNames: o }),
            t.append(
            ...
            e.add(1, "d");
        var s, d, l;
        n.find("tbody").empty().append(i),
          (s = N.find(".datepicker-months")),
          (d = s.find("th")),
          (l = s.find("tbody").find("span")),
          d.eq(0).find("span").attr("title", p.tooltips.prevYear),
          d.eq(1).attr("title", p.tooltips.selectYear),
          d.eq(2).find("span").attr("title", p.tooltips.nextYear),
          s.find(".disabled").removeClass("disabled"),
          m(H.clone().subtract(1, "y"), "y") || d.eq(0).addClass("disabled"),
          d.eq(1).text(H.year()),
          m(H.clone().add(1, "y"), "y") || d.eq(2).addClass("disabled"),
          l.removeClass("active"),
          E.isSame(H, "y") && !W && l.eq(E.month()).addClass("active"),
          l.each(function (e) {
    ...
    function e() {
      ...
      Y ||
        ...
        e.text(E.format("A")),
        m(t, "h") ? e.removeClass("disabled") : e.addClass("disabled")),
    ...
    function g(e) {
      ...
      if (!e)
        return (
          ...
          I.val(""),
          i.data("date", ""),
          h({ type: "dp.change", date: !1, oldDate: t }),
          void y()
        );
      if (
      ...
      m(e)
        ? ((H = (E = e).clone()),
          ...
          (W = !1),
          y(),
          h({ type: "dp.change", date: E.clone(), oldDate: t }))
        : (p.keepInvalid
            ? h({ type: "dp.change", date: e, oldDate: t })
            : I.val(W ? "" : E.format(q)),
          h({ type: "dp.error", date: e, oldDate: t }));
    }
    function b() {
      var t = !1;
      return N
    ...
    var E,
      ...
      X = {
        ...
        selectMonth: function (e) {
          ...
          H.month(t),
            j === V
              ? (g(E.clone().year(H.year()).month(H.month())), p.inline || b())
              : (o(-1), s()),
            r("M");
        },
        selectYear: function (e) {
          ...
          H.year(t),
            j === V
              ? (g(E.clone().year(H.year())), p.inline || b())
              : (o(-1), s()),
            r("YYYY");
        },
        ...
        selectDay: function (e) {
          ...
          $(e.target).is(".old") && t.subtract(1, "M"),
            ...
            g(t.date(parseInt($(e.target).text(), 10))),
        ...
        togglePicker: function (e) {
          ...
          if (r && r.length) {
            ...
            r.collapse
              ...
              : (r.removeClass("in"), i.addClass("in")),
              a.is("span")
                ? a.toggleClass(p.icons.time + " " + p.icons.date)
                : a.find("span").toggleClass(p.icons.time + " " + p.icons.date);
          }
        },
        showPicker: function () {
        ...
        selectMinute: function (e) {
          g(E.clone().minutes(parseInt($(e.target).text(), 10))),
            X.showPicker.call(L);
        },
        selectSecond: function (e) {
          g(E.clone().seconds(parseInt($(e.target).text(), 10))),
            X.showPicker.call(L);
        },
        clear: w,
        today: function () {
    ...
    if (
      ...
      (L.maxDate = function (e) {
        ...
        return (
          (p.maxDate = t),
          p.useCurrent && !p.keepInvalid && E.isAfter(e) && g(p.maxDate),
      ...
      (L.minDate = function (e) {
        ...
        return (
          (p.minDate = t),
          p.useCurrent && !p.keepInvalid && E.isBefore(e) && g(p.minDate),
    ...
    return (
      ...
      $.extend(
        ...
        p,
        ((F = {}),
        (A = i.is("input") || p.inline ? i.data() : i.find("input").data())
          .dateOptions &&
          A.dateOptions instanceof Object &&
          (F = $.extend(!0, F, A.dateOptions)),
        $.each(p, function (e) {
      ...
      I.is("input") && 0 !== I.val().trim().length
        ? g(v(I.val().trim()))
        : p.defaultDate && void 0 === I.attr("placeholder") && g(p.defaultDate),
      p.inline && D(),
      L
    );
  }
